...
<br>
	<h6 class="display-6">Tabela Profesor:</h6>
	<br />
</div>
	<%
	jb.connect();
	...
	String[] valori = { Nume, Prenume, CNP, Adresa, Salariu, Grad, Vechime };
	String[] campuri = { "Nume", "Prenume", "CNP", "Adresa", "Salariu", "Grad", "Vechime" };
	jb.modificaTabela("profesor", "idprofesor", aux, campuri, valori);
	jb.disconnect();
	%>
	<div class="container text-center">
